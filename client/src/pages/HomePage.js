...
export default function HomePage() {
  ...
  return (
    <Container>
      {/* SongCard is a custom component that we made. selectedSongId && 
      <SongCard .../> makes use of short-circuit logic to only render 
      the SongCard if a non-null song is selected */}
      {selectedSongId && (
        <SongCard
      ...
      {/* <h2>
        Check out your park of the day:&nbsp;
        <Link onClick={() => setSelectedSongId(songOfTheDay.song_id)}>
          {songOfTheDay.full_name}
        </Link>
      </h2> */}
      <Divider />
      <h2>Top Parks</h2>
